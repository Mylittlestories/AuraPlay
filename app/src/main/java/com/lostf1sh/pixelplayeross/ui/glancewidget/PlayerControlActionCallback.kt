...
object PlayerActions {
    ...
    const val PLAY_PAUSE = "com.lostf1sh.pixelplayeross.ACTION_WIDGET_PLAY_PAUSE"
    const val NEXT = "com.lostf1sh.pixelplayeross.ACTION_WIDGET_NEXT"
    const val PREVIOUS = "com.lostf1sh.pixelplayeross.ACTION_WIDGET_PREVIOUS"
    const val FAVORITE = "com.lostf1sh.pixelplayeross.ACTION_WIDGET_FAVORITE"
    const val PLAY_FROM_QUEUE = "com.lostf1sh.pixelplayeross.ACTION_WIDGET_PLAY_FROM_QUEUE"
    const val SHUFFLE = "com.lostf1sh.pixelplayeross.ACTION_WIDGET_SHUFFLE"
    const val REPEAT = "com.lostf1sh.pixelplayeross.ACTION_WIDGET_REPEAT"
}
